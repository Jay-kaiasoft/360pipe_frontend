                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-transparent">
                                ...
                                <th className="px-3 py-2 md:px-6 md:py-4 text-center text-lg md:text-[28px] font-semibold bg-[#2753AF] text-white rounded-tr-2xl rounded-tl-2xl border-[#e7e8ec66] border-b">
                                    360Pipe
                                </th>
                        ...
                        <tbody className="bg-white shadow-2xl shadow-[#e7e8ec66] rounded-2xl">
                            {features.map((feature, idx) => (
                                <tr key={idx}>
                                    ...
                                    <td className={`px-3 py-2 md:px-6 md:py-4 text-center bg-[#2753AF] border-[#e7e8ec66] border-b text-xl font-medium`}>
                                        {feature.pipe ? (
                                            <img
                                                src={Check}
                                                alt="check"
