...
const Calendar = ({ setAlert }) => {
  ...
  const [selectedSlot, setSelectedSlot] = useState(null);   // for ADD    
  ...
  // When user clicks empty date/time box (month/week/day)
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-8 h-full">
        ...
        <div className="w-full lg:w-3/4 h-[800px]">
          <BigCalendar
            ...
            onSelectSlot={handleSlotSelect}    // ⬅️ ADD
            onSelectEvent={handleEventSelect}  // ⬅️ ADD
            style={{ height: 700 }}
            components={{
      ...
      <AddEventModel
        ...
        handleGetAllEvents={() => loadGoogleEvents(date)}
      />
